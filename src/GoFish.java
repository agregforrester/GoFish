...
public class GoFish {
    ...
    public void play() {
        ...
        System.out.print("\n2 Player Game or Versus the CPU? Type '2P' for two players, or type 'CPU' for the computer.");
        answer = in1.next();

        if (answer.equals("CPU") || answer.equals("cpu")) {
            shuffleAndDeal();
        ...
        } else if (answer.equals("2P") || answer.equals("2p")) {
            shuffleAndDeal();
